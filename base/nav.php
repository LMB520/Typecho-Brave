...
<div class="container">
<a class="navbar-brand sweepinglight" href="<?php Helper::options()->siteUrl() ?>"><?php $this->options->title() ?></a>
...
<img class="mx-auto avatar-img rounded-circle lazy" src="/usr/themes/Brave/asset/img/lazyload.svg" data-original="<?php $this->options->boy(); ?>"
alt="<?php $this->options->boyname(); ?>">
<h4 class="mx-auto text-white pt-2"><?php $this->options->boyname();
?></h4>
</div>
</div>
<div class="col">
...
<div class="col">
<div class="d-flex flex-column">
<img class="mx-auto avatar-img rounded-circle lazy" src="/usr/themes/Brave/asset/img/lazyload.svg" data-original="<?php $this->options->girl(); ?>"
alt="<?php $this->options->girlname(); ?>">
<h4 class="mx-auto text-white pt-2"><?php $this->options->girlname();
?></h4>
</div>
</div>
</div>
