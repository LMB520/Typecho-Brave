<div class="container-fluid position-relative">
    <nav class="navbar navbar-expand-lg navbar-dark text-white bg-transparent">
        <div class="container">
            <a class="navbar-brand sweepinglight"
               href="<?php Helper::options()->siteUrl() ?>"><?php $this->options->title() ?></a>
        ...
        <div class="row align-items-center pb-5 lover">
            <div class="col">
                <div class="d-flex flex-column">
                    <img class="mx-auto avatar-img rounded-circle lazy" src="/usr/themes/Brave/asset/img/lazyload.svg"
                         data-original="<?php $this->options->boy(); ?>"
            ...
            <div class="col">
                <div class="d-flex flex-column">
                    <img class="mx-auto avatar-img rounded-circle lazy" src="/usr/themes/Brave/asset/img/lazyload.svg"
                         data-original="<?php $this->options->girl(); ?>"
